 ...
 *
 * Telefonzeile aus dem Mockup NICHT übernommen — die dort gezeigte Nummer
 * (+49 30 1234 5678) ist ein erfundener Platzhalterwert, kein echter
 * Calltalent-Kontakt (gleiches Prinzip wie an anderer Stelle im Projekt:
 * keine erfundenen Werte aus dem Mockup). Nur die echte, bereits im ganzen
 * Projekt verwendete Adresse office@calltalent.ai wird gezeigt.
 */
        ...
        <div className="max-w-[460px]">
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div>
              ...
              <div className="text-base font-semibold text-white">office@calltalent.ai</div>
            </div>
          </div>
        </div>
