...
6. **Migrations-Importer nicht ausbauen.** Ein Importer für LearningSuite, Teachable und Kajabi steht in Phase 4 des Phasenplans und wäre wochenlange Arbeit für einen Fall, den es noch kein einziges Mal gab. Bis zum ersten Umzugskunden reichen der vorhandene CSV-Import für Nutzer und eine Seite Dokumentation, wie ein Kurs von Hand übertragen wird.
7. **Kein weiterer Funktionsbereich** (Kommentare, Gamification, Lernpfade, SSO), bevor Position 25 erreicht ist.
...
14. **Drei Freigaben nach CLAUDE.md §4.6.** Ohne ausdrückliche Zustimmung passiert keines davon: das Löschen der 104 synthetischen Konten und des Testprodukts „Manual Buy Check" samt zwei bezahlter Bestellungen aus der Produktionsdatenbank; der Merge der beiden Branches nach `main` mit anschließendem Deploy; der erste Referenzkurs direkt in der Produktionsdatenbank im Mandanten `demo-blau`.
15. **Zweiter Betreiber-Zugang und MFA.** `platform_admins` enthält live genau eine Zeile (selbst geprüft). Fällt dieses Konto aus oder wird es übernommen, ist das mächtigste Konto der Plattform weg oder in fremder Hand, und es gibt keinen zweiten Weg hinein. Ein zweiter Betreiber-Zugang auf eine eigene Adresse und MFA für beide Konten kosten eine halbe Stunde.
16. **Bunny-Webhook im Dashboard eintragen.** Er muss von Hand gesetzt werden (PHASENSTATUS, Zeile 2376). Ohne ihn feuert Status 3 und 9 nie, es entstehen also weder Transkripte noch Untertitel, und der Tutor bleibt für Videokurse blind. Betrifft direkt zwei der drei beworbenen KI-Funktionen.
17. **BFSG-Einordnung anwaltlich bestätigen lassen.** § 3 Abs. 3 BFSG nimmt Kleinstunternehmen, die Dienstleistungen anbieten, von den Anforderungen aus; Kleinstunternehmen ist nach § 2 Nr. 17 BFSG, wer weniger als zehn Personen beschäftigt und höchstens 2 Millionen Euro Jahresumsatz oder Bilanzsumme hat. Für die Calltalent LLC dürfte das gelten, für einen Mandanten, der über die Plattform an Verbraucher verkauft, nicht zwangsläufig. Die Antwort entscheidet, ob die Erklärung zur Barrierefreiheit Pflicht oder Verkaufsargument ist.
18. **Website-Repo.** Der Branch mit der Umstellung auf die LLC ist im Repo `calltalent-website` nicht gemergt; calltalent.ai nennt bis dahin den falschen Rechtsträger. Dieser Punkt stammt aus dem Ruflo-Bericht vom 07.09. und ist in dieser Analyse nicht selbst geprüft, weil das Repo nicht Teil des Prüfumfangs war.
